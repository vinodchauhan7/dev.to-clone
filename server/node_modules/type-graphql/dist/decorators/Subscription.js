...
function Subscription(returnTypeFuncOrOptions, maybeOptions) {
    ...
    return (prototype, methodName) => {
        ...
        getMetadataStorage_1.getMetadataStorage().collectSubscriptionHandlerMetadata(Object.assign({}, metadata, { topics: options.topics, filter: options.filter, subscribe: options.subscribe }));
    };
}
